...
using WebView = Android.Webkit.WebView; // Avoids conflict with Microsoft.Maui.Controls.Webview
using View = Android.Views.View; // Avoids conflict with Microsoft.Maui.Controls.View

namespace BlazorApp.Maui.Platforms.Android;
